...
|------|------|--------|---------|-----------|---------|--------|----------|
| 第一期：P0 修错 | [phase-1-fixes.md](./phase-1-fixes.md) | 10 | 6 | 0 | 0 | 60% | 🔄 进行中 |
| 第二期：结构重构 | [phase-2-restructure.md](./phase-2-restructure.md) | 12 | 0 | 0 | 0 | 0% | ⬜ 未开始 |
| 第三期：编排方法论增强 | [phase-3-orchestration.md](./phase-3-orchestration.md) | 16 | 0 | 0 | 0 | 0% | ⬜ 未开始 |
| **总计** | — | **38** | **6** | **0** | **0** | **16%** | — |

**最近更新**：2026-06-12（T1.6 完成）

### 里程碑

- [ ] M1：第一期全部完成 → 插件无已知硬错误，可放心日常使用
- [ ] M2：第二期全部完成 → 三个 skill 结构达标（行数、分档、agent 对齐、触发边界）
