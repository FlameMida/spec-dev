...
- 使用 `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/assets/spec-template.md` 与 `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/assets/plan-template.md` 生成或覆盖文档。
...
- 使用 `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/assets/acceptance-report-template.md` 生成 `acceptance-report.md`。
...
所有内部调用都遵循 `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/references/command-contract.md` 中定义的 CLI 约定。
...
- Action guide: `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/references/action-explore.md`
- Planning guide: `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/references/action-plan.md`
- Implement guide: `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/references/action-implement.md`
- Acceptance guide: `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/references/action-accept.md`
- Archive guide: `${CLAUDE_PLUGIN_ROOT}/skills/spec-flow/references/action-archive.md`
