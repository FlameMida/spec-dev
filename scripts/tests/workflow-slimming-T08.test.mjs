...
const files=['skills/test-strategy/SKILL.md','skills/test-strategy/references/frontend-testing.md','skills/test-strategy/references/ai-agent-testing.md','skills/test-strategy/references/db-testing.md','skills/test-strategy/agents/openai.yaml','skills/test-strategy/evals/evals.json','skills/test-strategy/evals/trigger-evals.json','skills/acceptance-qa/references/acceptance-matrix.md','skills/acceptance-qa/SKILL.md','skills/requirement-analysis/assets/spec-template.md'];
